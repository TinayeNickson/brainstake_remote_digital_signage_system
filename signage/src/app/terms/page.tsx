...
export const metadata = {
  title: 'Terms of Service — RareVision',
};
    ...
    <main className="min-h-screen bg-[#f6f4ef]">
      ...
      <article className="max-w-3xl mx-auto px-6 py-14 prose prose-stone prose-sm sm:prose-base">
        ...
        <Section title="1. Introduction">
          <p>
            These Terms of Service (&quot;Terms&quot;) govern your access to and use of the RareVision digital
            signage platform (&quot;Platform&quot;), operated by RareVision (Private) Limited
            (&quot;RareVision&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;). By registering an account or
        ...
        <Section title="3. Account Registration">
          <p>
            ...
            if you suspect unauthorised access to your account. RareVision is not liable for any loss arising
        ...
        <Section title="4. Advertising Bookings">
          <ul>
            ...
            <li>
              RareVision does not guarantee uninterrupted display due to factors outside our control
        ...
        <Section title="7. Advertising Content Policy">
          ...
          <p>
            RareVision reserves the right to remove or refuse any content that violates this policy,
        ...
        <Section title="8. Emergency Broadcasts">
          <p>
            RareVision reserves the right to interrupt scheduled advertising to display emergency or
        ...
        <Section title="9. Intellectual Property">
          <p>
            ...
            Platform you grant RareVision a non-exclusive, royalty-free licence to display that content
          ...
          <p>
            ...
            RareVision (Private) Limited. You may not copy, reproduce, or use them without written
            permission.
          </p>
        </Section>
        ...
        <Section title="10. Limitation of Liability">
          <p>
            To the maximum extent permitted by law, RareVision&apos;s total liability to you for any claim
          ...
          <p>
            RareVision is not liable for indirect, incidental, special, or consequential damages including
        ...
        <Section title="11. Termination">
          <p>
            ...
            abuse the Platform, or engage in conduct that is harmful to RareVision or other users.
