    ...
    <div style="background:#fff;border:1px solid #ddd8cc;border-radius:8px;overflow:hidden;">
      ...
      <div style="background:#0a2e1f;padding:28px 36px;">
          ...
          <tr>
            ...
            <td style="text-align:right;vertical-align:top;">
              ...
              <div style="display:inline-block;background:rgba(255,255,255,0.12);border-radius:10px;padding:8px;width:48px;height:48px;box-sizing:border-box;">
                <img src="${process.env.NEXT_PUBLIC_APP_URL ?? 'http://localhost:3000'}/logo.png" alt="RareVision" width="32" height="32" style="display:block;width:32px;height:32px;object-fit:contain;" />
              </div>
            </td>
          </tr>
        </table>
        ...
        <div style="border-top:1px solid rgba(255,255,255,0.12);padding-top:14px;">
          <div style="color:#fff;font-size:15px;font-weight:700;letter-spacing:-.01em;">RareVision</div>
          <div style="color:rgba(255,255,255,.45);font-size:11px;margin-top:2px;">Digital Signage Advertising &nbsp;&middot;&nbsp; info@rarevision.tech</div>
        </div>
      </div>
      ...
      <div style="padding:28px 36px;">
        ...
        <p style="font-size:12px;color:#aaa;text-align:center;margin:0;line-height:1.6;">
          ...
          Log in to your RareVision portal to view and save a PDF copy at any time.
        </p>
      </div>
      ...
      <div style="padding:14px 36px;background:#f6f4ef;border-top:1px solid #e8e4dc;font-size:11px;color:#aaa;text-align:center;letter-spacing:.05em;">
        RareVision &middot; Digital Signage Advertising &middot; info@rarevision.tech
      </div>
    </div>
  </div>
</body></html>`;
